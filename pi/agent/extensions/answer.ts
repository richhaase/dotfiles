/**
 * Q&A extraction — extracts questions from assistant responses and presents
 * an interactive TUI for answering them one at a time.
 *
 * Based on https://github.com/mitsuhiko/agent-stuff/blob/main/pi-extensions/answer.ts
 *
 * Usage: /answer or Ctrl+.
 */
...
export default function (pi: ExtensionAPI) {
	const answerHandler = async (ctx: ExtensionContext) => {
		...
		// Extract questions with spinner
